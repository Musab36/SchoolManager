...
import com.salajim.musab.schoolmanager.activities.GradesDetailActivity;
...
public class GradesAdapter extends RecyclerView.Adapter<GradesAdapter.MyViewHolder>{
    ...
    public GradesAdapter(Context mContext, List<Students> studentsLists) {
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(mContext, GradesDetailActivity.class);
