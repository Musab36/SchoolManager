...
public class FriAdapter extends RecyclerView.Adapter<FriAdapter.MyViewHolder>{
    private Context mContext;
    private List<Schedule> schedules;

    public FriAdapter(Context mContext, List<Schedule> schedules) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(schedule.getDay().contains("Friday")) {
