...
public class TueAdapter extends RecyclerView.Adapter<TueAdapter.MyViewHolder>{
    private Context mContext;
    private List<Schedule> schedules;

    public TueAdapter(Context mContext, List<Schedule> schedules) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(schedule.getDay().contains("Tuesday")) {
