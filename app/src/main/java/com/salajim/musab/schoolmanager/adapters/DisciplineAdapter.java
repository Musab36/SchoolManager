...
import com.salajim.musab.schoolmanager.activities.DisciplineDetailActivity;
...
public class DisciplineAdapter extends RecyclerView.Adapter<DisciplineAdapter.MyViewHolder>{
    ...
    public DisciplineAdapter(Context mContext, List<Students> studentsLists) {
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(mContext, DisciplineDetailActivity.class);
