...
public class WedAdapter extends RecyclerView.Adapter<WedAdapter.MyViewHolder>{
    private Context mContext;
    private List<Schedule> schedules;

    public WedAdapter(Context mContext, List<Schedule> schedules) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(schedule.getDay().contains("Wednesday")) {
